...
var cornify_add = function cornify_add(options) {
  ...
  cornify_count += 1; // Prepare our lovely variables.
  ...
  var showGrandUnicorn = cornify_count == 15; // Create a container for our 'corn or 'bow.
  ...
  var url = cornify_url + 'getacorn.php?r=' + submitTime + '&url=' + document.location.href; // Add younicorns if requested.
  ...
  img.setAttribute('src', url); // Add a nice hover wigggle.
  ...
  div.appendChild(img); // Hooray - now we have a sparkly unicorn (or rainbow) on the page. Another cornification well done. Congrats!
  ...
  cornify_updatecount(); // Trigger an event on the document.
...
var cornify_updatecount = function cornify_updatecount() {
...
var cornify_setcookie = function cornify_setcookie(name, value, days) {
  var d = new Date();
...
var cornify_getcookie = function cornify_getcookie(cname) {
  var name = cname + '=';
...
var cornify_replace = function cornify_replace() {
  // Replace text.
  var hc = 6;
  var hs;
  var h;
...
var cornify_click_cupcake_button = function cornify_click_cupcake_button() {
  var doc = document;
...
var cornify_add_cupcake_button = function cornify_add_cupcake_button() {
